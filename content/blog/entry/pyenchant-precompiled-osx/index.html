...
{% syntax console %}# create three different compile trees for the three architectures.
...
{% syntax console %}$> lipo -info ./libglib.dylib
...
{% syntax console %}$> otool -L ./build/lib/libglib-2.0.0.dylib
...
{% syntax console %}$> otool -L ./enchant/lib/libglib-2.0.0.dylib
